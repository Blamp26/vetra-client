...
export function LoginForm({ onSwitchToRegister }: Props) {
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-8 w-full max-w-[400px]">
      <h2 className="text-[1.3rem] font-semibold mb-6 text-foreground">Welcome Back</h2>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <div className="space-y-1.5">
          <label className="text-[0.78rem] font-semibold uppercase tracking-[0.06em] text-muted-foreground" htmlFor="login-username">
            Username
          </label>
          <input
        ...
        <div className="space-y-1.5">
          <label className="text-[0.78rem] font-semibold uppercase tracking-[0.06em] text-muted-foreground" htmlFor="login-password">
            Password
          </label>
