...
export function StickerPicker({ onSend, onClose, selectionRequest, onSelectionHandled }: { onSend: (id: string) => Promise<void>; onClose: () => void; selectionRequest?: StickerPackSelectionRequest | null; onSelectionHandled?: (revision: number) => void }) {
